...
var marked0$0 = [flattenAllSubjects].map(regeneratorRuntime.mark);
...
var reducer = _require2.reducer;
var selector = _require2.selector;
...
function loadSubjectsAndEdit(subjects, _id) {
    return apply({ type: LOAD_SUBJECTS_RESULTS, subjects: subjects }, { type: EDIT_SUBJECT, _id: _id }).subjects.editSubjectsPacket.eligibleParents;
}
...
function flattenAllSubjects(subjects) {
    var i;
    return regeneratorRuntime.wrap(function flattenAllSubjects$(context$1$0) {
        while (1) switch (context$1$0.prev = context$1$0.next) {
            ...
            case 1:
                ...
                return context$1$0.delegateYield(flattenAllSubjects(subjects[i].children), 't0', 4);
